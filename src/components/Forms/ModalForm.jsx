...
function ModalForm({ data, template, label, readonly, show, handleSave, handleClose, externalImport = [] }) {
  ...
  return (
    <Modal className="dmpopidor-branding" show={show} backdrop={ 'static' } onHide={handleModalClose}>
      ...
      <Modal.Body style={{ padding: "20px !important" }}>
        {externalImport?.length > 0 && <ImportExternal fragment={methods.getValues()} setFragment={methods.reset} externalImport={externalImport} />}
